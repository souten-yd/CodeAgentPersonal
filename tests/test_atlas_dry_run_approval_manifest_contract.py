...
def test_manifest_contract_pr85() -> None:
    ...
    assert m["dry_run_approval_runtime_gate"] == "metadata_only_manual_foundation"
    assert m["dry_run_first_required"] is True
    assert m["execute_one_action_required"] is True
