...
def test_scale_93c_canonical_current_state_and_tracks() -> None:
    for doc in DOCS:
        ...
        assert ('Current automation track: PR-ATLAS-SCALE-96' in section) or ('Current automation track: PR-ATLAS-SCALE-98' in section) or ('Current automation track: PR-ATLAS-SCALE-99' in section) or ('Current automation track: PR-ATLAS-SCALE-101' in section)
        assert ('Next automation track: PR-ATLAS-SCALE-96' in text) or ('Completed automation PR: PR-ATLAS-SCALE-97' in text) or ('Next automation track: PR-ATLAS-SCALE-97' in text) or ('Current automation track: PR-ATLAS-SCALE-98' in text) or ('Current automation track: PR-ATLAS-SCALE-99' in text) or ('Current automation track: PR-ATLAS-SCALE-101' in text) or ('Next automation track: PR-ATLAS-SCALE-101' in text)
