...
def test_scale_97b_docs_pointer_and_track_state() -> None:
    ...
    for path in DOCS:
        ...
        assert 'Completed automation PR: PR-ATLAS-SCALE-97' in text
        assert 'Current automation track: PR-ATLAS-SCALE-98' in text
        assert 'Next automation track: PR-ATLAS-SCALE-98' in text
