...
def test_scale_96b_pointer_and_gate_id_consistency_contract() -> None:
    for doc in DOCS:
        ...
        assert ('Current automation track: PR-ATLAS-SCALE-98' in t) or ('Current automation track: PR-ATLAS-SCALE-99' in t) or (('Current automation track: PR-ATLAS-SCALE-103' if 'Current automation track: PR-ATLAS-SCALE-103' in t else 'Current automation track: PR-ATLAS-SCALE-105') in t)
