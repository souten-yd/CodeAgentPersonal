...
def test_active_pointer_summary_describes_scale_105_not_scale_104():
    ...
    assert 'Completed automation PR: PR-ATLAS-SCALE-105' in active
    assert 'PR-ATLAS-SCALE-105 completed: local-only readiness metadata history diff export/copy' in active
