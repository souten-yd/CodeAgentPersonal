...
def test_active_pr_pointer_and_current_track_sections_are_scale_109_chain():
    for path in DOC_PATHS:
        ...
        assert 'Planned UI track: return to PR-ATLAS-SCALE-112 automation track' in current_state
        assert 'Current automation track: PR-ATLAS-SCALE-112' in current_state
        assert 'Next automation track: PR-ATLAS-SCALE-112' in current_state
        assert 'next work is PR-ATLAS-SCALE-112' in current_state
