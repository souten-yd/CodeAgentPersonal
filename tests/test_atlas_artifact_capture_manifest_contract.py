...
def test_manifest_artifact_capture_contract() -> None:
    ...
    assert m['artifact_capture_runtime_gate'] == 'metadata_only_manual_foundation'
    assert m['artifact_capture_auto_enabled'] is False
    assert m['artifact_capture_requires_data_root'] is True
    assert m['artifact_capture_index_policy'] == 'metadata_only_references'
