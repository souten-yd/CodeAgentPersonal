...
def test_scale_96_docs_track_pointers() -> None:
    for doc in DOCS:
        ...
        assert ('Current automation track: PR-ATLAS-SCALE-98' in t) or ('Current automation track: PR-ATLAS-SCALE-99' in t) or ((('Current automation track: PR-ATLAS-SCALE-103' if 'Current automation track: PR-ATLAS-SCALE-103' in t else 'Current automation track: PR-ATLAS-SCALE-105') in t) or ('Current automation track: PR-ATLAS-SCALE-105' in t))
        assert ('Next automation track: PR-ATLAS-SCALE-98' in t) or ('Next automation track: PR-ATLAS-SCALE-99' in t) or ('Next automation track: PR-ATLAS-SCALE-101' in t) or (('Next automation track: PR-ATLAS-SCALE-103' in t) or ('Next automation track: PR-ATLAS-SCALE-104' in t) or ('Next automation track: PR-ATLAS-SCALE-105' in t))
        assert ('next work is PR-ATLAS-SCALE-99' in t) or ('next work is PR-ATLAS-SCALE-101' in t) or ('next work is PR-ATLAS-SCALE-102' in t) or ('next work is PR-ATLAS-SCALE-105' in t)
