...
def test_docs_canonical_current_state_has_final_v21c_wording() -> None:
    for doc in DOCS:
        ...
        assert ('Current automation track: PR-ATLAS-SCALE-103' if 'Current automation track: PR-ATLAS-SCALE-103' in section else 'Current automation track: PR-ATLAS-SCALE-108') in section
