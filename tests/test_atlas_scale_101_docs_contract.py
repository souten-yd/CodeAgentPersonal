...
def test_docs_advance_tracks_and_safety_for_scale_101():
    for d in DOCS:
        ...
        assert (('Current automation track: PR-ATLAS-SCALE-111' if 'Current automation track: PR-ATLAS-SCALE-111' in t else 'Current automation track: PR-ATLAS-SCALE-111') in t) or ('Current automation track: PR-ATLAS-SCALE-111' in t)
