...
STATIC_EXPECTATIONS: list[StaticCase] = [
    ...
    StaticCase("css_variable_hue_js", "hue rotate", "passed", ("animation_signal", "color_mutation_signal")),
    ...
    StaticCase("static_plain", "show an inanimate object", "passed"),
...
AUTOVERIFY_EXPECTATIONS: list[AutoVerifyCase] = [
    ...
    AutoVerifyCase("css_variable_hue_js", "hue rotate", {"status": "browser_smoke_passed"}, "passed", "runtime_smoke_checked", ("visual_contract_passed",)),
    ...
    AutoVerifyCase("static_plain", "animate colors", {"status": "browser_smoke_failed", "reason": "animation_not_detected"}, "passed", "static_checked", ("browser_smoke_warning:animation_not_detected",)),
