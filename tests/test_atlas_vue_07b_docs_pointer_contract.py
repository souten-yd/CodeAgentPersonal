...
def test_vue_07b_docs_pointer_contract() -> None:
    ...
    assert 'pr-atlas-vue-07: vue read-only parity tests / visual refinement' in roadmap
    assert 'current ui track: pr-atlas-vue-08: safe static mount/dist strategy' in roadmap
