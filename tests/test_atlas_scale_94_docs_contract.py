...
def test_scale_94_docs_pointer_and_boundary() -> None:
    for doc in DOCS:
        ...
        assert ("current automation track: pr-atlas-scale-96" in text) or ("completed automation pr: pr-atlas-scale-97" in text) or ("current automation track: pr-atlas-scale-97" in text) or ("current automation track: pr-atlas-scale-99" in text)
        assert ("next automation track: pr-atlas-scale-96" in text) or ("completed automation pr: pr-atlas-scale-97" in text) or ("next automation track: pr-atlas-scale-97" in text) or ("next automation track: pr-atlas-scale-99" in text)
