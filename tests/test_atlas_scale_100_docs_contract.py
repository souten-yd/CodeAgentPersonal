...
def test_docs_scale_100_completion_and_101_pointer_contract():
    for d in DOCS:
        ...
        assert (('Current automation track: PR-ATLAS-SCALE-103' if 'Current automation track: PR-ATLAS-SCALE-103' in t else 'Current automation track: PR-ATLAS-SCALE-105') in t) or ('Current automation track: PR-ATLAS-SCALE-105' in t)
        assert ('Next automation track: PR-ATLAS-SCALE-103' in t) or ('Next automation track: PR-ATLAS-SCALE-104' in t) or ('Next automation track: PR-ATLAS-SCALE-105' in t)
        assert 'next work is PR-ATLAS-SCALE-105' in t
