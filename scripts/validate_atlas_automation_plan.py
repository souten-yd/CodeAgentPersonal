...
def validate() -> None:
    ...
    assert phase["completed_automation_pr"] == "PR-ATLAS-SCALE-117"
    assert phase["current_automation_track"] == "PR-ATLAS-SCALE-118"
    assert phase["next_automation_track"] == "PR-ATLAS-SCALE-118"
