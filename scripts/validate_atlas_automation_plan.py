...
def validate() -> None:
    ...
    assert phase["completed_automation_pr"] == "PR-ATLAS-SCALE-122"
    assert phase["current_automation_track"] == "PR-ATLAS-SCALE-123"
    assert phase["next_automation_track"] == "PR-ATLAS-SCALE-123"
