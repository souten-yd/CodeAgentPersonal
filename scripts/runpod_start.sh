...
export DEFAULT_LLM_CTX_SIZE="${DEFAULT_LLM_CTX_SIZE:-32768}"
...
export NEXUS_DEEP_RESEARCH_CONTEXT_PROFILE="${NEXUS_DEEP_RESEARCH_CONTEXT_PROFILE:-extended_32k}"
...
export SEARXNG_ENGINE_PROFILE="${SEARXNG_ENGINE_PROFILE:-safe_research}"
export SEARXNG_SAFE_KEEP_ONLY_ENGINES="${SEARXNG_SAFE_KEEP_ONLY_ENGINES:-wikipedia,wikidata,arxiv,crossref,openalex,semantic scholar,github,stackoverflow}"
export SEARXNG_DISABLED_ENGINES="${SEARXNG_DISABLED_ENGINES:-duckduckgo,startpage,google,bing,brave,karmasearch,karmasearch videos,qwant,mojeek,yahoo}"
...
echo "[Runpod] NEXUS_ANSWER_LLM_MAX_CONTEXT_TOKENS=${NEXUS_ANSWER_LLM_MAX_CONTEXT_TOKENS}"
echo "[Runpod] NEXUS_DEEP_RESEARCH_CONTEXT_PROFILE=${NEXUS_DEEP_RESEARCH_CONTEXT_PROFILE}"
...
echo "[Runpod] SEARXNG_ENGINE_PROFILE=${SEARXNG_ENGINE_PROFILE}"
echo "[Runpod] SEARXNG_SAFE_KEEP_ONLY_ENGINES=${SEARXNG_SAFE_KEEP_ONLY_ENGINES}"
echo "[Runpod] SEARXNG_DISABLED_ENGINES=${SEARXNG_DISABLED_ENGINES}"
echo "[Runpod] SEARXNG_HEALTH_ENGINE=${SEARXNG_HEALTH_ENGINE}"
echo "[Runpod] SEARXNG_FORCE_SAFE_SETTINGS=${SEARXNG_FORCE_SAFE_SETTINGS}"
echo "[Runpod] SEARXNG_REPAIR_SETTINGS=${SEARXNG_REPAIR_SETTINGS}"
