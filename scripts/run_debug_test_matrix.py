...
TEST_PRESETS: list[TestPreset] = [
    TestPreset("desktop_lumen_input_visible", "Desktop Lumen input visible", "Real-browser computed layout check for desktop Lumen chat input + right panel", [sys.executable, "scripts/smoke_ui_modes_playwright.py", "--only", "desktop-lumen-input"], {"PLAYWRIGHT_SMOKE_BASE_URL": "", "RUN_ATLAS_BACKEND_PREFLIGHT": "0", "RUN_ATLAS_BACKEND_E2E": "0"}, 600),
...
DIAGNOSTIC_TEST_PRESETS: list[TestPreset] = [
    TestPreset("clarification_resolution", "Clarification resolution", "Resolve clarification path (diagnostic; fixture/hook dependent)", [sys.executable, "scripts/smoke_ui_modes_playwright.py"], {"PLAYWRIGHT_SMOKE_BASE_URL": "http://127.0.0.1:8000", "RUN_ATLAS_BACKEND_PREFLIGHT": "1", "RUN_ATLAS_BACKEND_E2E": "1", "RUN_ATLAS_BACKEND_E2E_WAIT_PLAN": "1", "RUN_ATLAS_BACKEND_E2E_RESOLVE_CLARIFICATION": "1"}, 900),
    TestPreset("plan_approval_gate", "Plan approval gate", "Validate gate visibility path (diagnostic)", [sys.executable, "scripts/smoke_ui_modes_playwright.py"], {"PLAYWRIGHT_SMOKE_BASE_URL": "http://127.0.0.1:8000", "RUN_ATLAS_BACKEND_PREFLIGHT": "1", "RUN_ATLAS_BACKEND_E2E": "1", "RUN_ATLAS_BACKEND_E2E_WAIT_PLAN": "1", "RUN_ATLAS_BACKEND_E2E_CHECK_PLAN_APPROVAL": "1"}, 900),
