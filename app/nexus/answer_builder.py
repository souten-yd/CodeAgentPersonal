    ...
    *,
    ...
    generation = {
        ...
        "context_budget": {
            ...
            "max_evidence_chunks": context_budget.max_evidence_chunks,
            "max_chars_per_chunk": context_budget.max_chars_per_chunk,
            "max_evidence_chars": context_budget.max_evidence_chars,
            "max_source_tokens": context_budget.max_source_tokens,
        },
        "error": llm_error,
        "notice": (
    ...
    payload = {
        ...
        "context_profile": context_budget.compression_profile,
        "context_budget": {
            "max_context_tokens": context_budget.max_context_tokens,
            "max_evidence_tokens": context_budget.max_evidence_tokens,
            "max_evidence_chunks": context_budget.max_evidence_chunks,
