...
def validate_conversational_shell_contract(contract: dict[str, Any]) -> dict[str, Any]:
    ...
    invariants = {
        ...
        "conversation_state": is_blocked or contract.get("conversation_state") in CONVERSATIONAL_STATES,
        "work_target_mode": is_blocked or contract.get("work_target_mode") in WORK_TARGET_MODES,
