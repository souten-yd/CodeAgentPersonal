...
def include_routers(app: FastAPI) -> None:
    ...
    """
    from app.api.atlas_workflow_state import router as atlas_workflow_state_router
    from app.api.atlas_runs import router as atlas_runs_router
    from app.api.atlas_automation_safety_profile import (
        router as atlas_automation_safety_profile_router,
    )
    ...
    from app.api.atlas_code_intel import router as atlas_code_intel_router
    ...
    from app.api.atlas_automation_features import router as atlas_automation_features_router
    ...
    from app.api.atlas_supervised_handoff_safe_apply import router as atlas_supervised_handoff_safe_apply_router
    ...
    app.include_router(atlas_code_intel_router)
    ...
    app.include_router(atlas_automation_features_router)
    ...
    app.include_router(atlas_supervised_handoff_safe_apply_router)
