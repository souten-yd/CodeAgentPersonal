...
if [ "${AUTO_START_SEARXNG}" = "true" ]; then
  ...
  export NEXUS_BROAD_WEB_ENGINES="${NEXUS_BROAD_WEB_ENGINES:-google,bing,brave,duckduckgo}"
  export NEXUS_EXPERIMENTAL_WEB_ENGINES="${NEXUS_EXPERIMENTAL_WEB_ENGINES:-mojeek}"
  export SEARXNG_DISABLED_ENGINES="${SEARXNG_DISABLED_ENGINES:-startpage,karmasearch,karmasearch videos,qwant,qwant images,qwant news,qwant videos,qwant web,yahoo}"
  ...
  export NEXUS_SEARXNG_ENGINES_NEWS="${NEXUS_SEARXNG_ENGINES_NEWS:-google,bing,brave,duckduckgo,wikipedia,wikidata}"
  export NEXUS_SEARXNG_ENGINES_MARKET="${NEXUS_SEARXNG_ENGINES_MARKET:-google,bing,brave,duckduckgo,wikipedia,wikidata,github}"
  export NEXUS_SEARXNG_ENGINES_SOURCE="${NEXUS_SEARXNG_ENGINES_SOURCE:-google,bing,brave,duckduckgo,wikipedia,wikidata,arxiv,crossref,openalex,github}"
  export NEXUS_SEARXNG_ENGINES_GENERAL="${NEXUS_SEARXNG_ENGINES_GENERAL:-google,bing,brave,duckduckgo,wikipedia,wikidata,github,stackoverflow}"
  export NEXUS_SEARXNG_ENGINES_OFFICIAL="${NEXUS_SEARXNG_ENGINES_OFFICIAL:-google,bing,brave,duckduckgo,wikidata,wikipedia,github}"
