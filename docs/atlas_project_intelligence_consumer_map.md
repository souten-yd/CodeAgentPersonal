...
| `AtlasCodeIntelService` | `agent/project_intelligence/adapters/code_intel.py:ProjectIntelligenceCodeIntelAdapter` | Project Intelligence adapter |
...
| `agent/atlas_code_explorer.py:extract_symbols / find_related_tests / search_code_excerpts / build_research_evidence` | `agent/project_intelligence/adapters/code_explorer.py:ProjectIntelligenceCodeExplorerAdapter` | Project Intelligence adapter |
