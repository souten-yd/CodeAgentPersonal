...
- PR-ATLAS-PIPE-35B fixes incomplete dry-run completion state.
- Pipeline should not show completed when queued items remain.
- depends_on step aliases such as step_1 are resolved or surfaced as dependency_waiting.
