...
from agent.agent_prompts import ADVERSARIAL_PLAN_CRITIQUE_PROMPT
...
class AdversarialPlanCritic:
    def __init__(self, llm_json_fn: Callable[[str, str], dict | None] | None, angles: list[str] | None = None) -> None:
