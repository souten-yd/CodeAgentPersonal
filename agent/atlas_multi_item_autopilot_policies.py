...
def list_multi_item_policies() -> list[AtlasMultiItemAutopilotPolicy]:
    return [
        ...
        AtlasMultiItemAutopilotPolicy(policy_id="full_auto_multi_item_v1", name="Full auto multi-item", description="Gated multi-item safe apply for low, medium, and high risk create/update items; critical and command actions remain forbidden.", allowed_risk_levels=["low", "medium", "high"], max_changed_files_total=20),
