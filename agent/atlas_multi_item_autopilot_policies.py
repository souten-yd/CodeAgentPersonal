...
def list_multi_item_policies() -> list[AtlasMultiItemAutopilotPolicy]:
    return [
        ...
        AtlasMultiItemAutopilotPolicy(policy_id="full_auto_multi_item_v1", name="Full auto multi-item", description="Autonomous code generation: applies low/medium/high-risk create/update items.", max_items=20, allowed_risk_levels=["low", "medium", "high"], require_approval=False),
